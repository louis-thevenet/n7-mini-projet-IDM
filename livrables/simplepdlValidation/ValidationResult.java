...
/**
 * Classe qui reprÃ©sente un rÃ©sultat de validation, c'est-Ã -dire une liste d'erreurs avec message
 * et objet concernÃ©.
 *
...
public class ValidationResult {
  /**
   * Classe interne qui reprÃ©sente une erreur, avec l'objet source de l'erreur et le message
   * associÃ©.
   */
  public static class ValidationError {
    ...
    public String toString() {
      return "Erreur dans " + Utils.guessName(this.object) + ": " + this.error;
    }
  }

  /**
   * Liste des erreurs enregistrÃ©es dans ce rÃ©sultat (prÃ©sumÃ©ment mise Ã  jour par un
   * validateur)
   */
  ...
  /**
   * Enregistre une erreur si et seulement si le test est Ã©chouÃ© (le boolÃ©en est Ã  faux). Cette
   * mÃ©thode permet d'Ã©crire les contraintes de maniÃ¨re un peu plus lisibles.
   *
  ...
  /**
   * RÃ©cupÃ¨re la liste des erreurs enregistrÃ©es dans le rÃ©sultat et associÃ©es Ã  une classe
   * donnÃ©e.
   *
  ...
  /**
   * RÃ©cupÃ¨re la liste des erreurs enregistrÃ©es dans le rÃ©sultat et associÃ©es Ã  une classe
   * donnÃ©e, sous la forme d'un identifiant de classe (gÃ©nÃ©ralement dÃ©fini dans le package
   * associÃ© au mÃ©ta-modÃ¨le).
   *
  ...
  public List<ValidationError> getRecordedErrorsFor(int classId) {
    return this.recordedErrors.stream()
        .filter(v -> v.object.eClass().getClassifierID() == classId)
        .toList();
  }
}
