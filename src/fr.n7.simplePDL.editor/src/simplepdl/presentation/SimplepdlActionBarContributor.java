 ...
 * @generated
 */
public class SimplepdlActionBarContributor extends EditingDomainActionBarContributor
  ...
  public void contributeToMenu(IMenuManager menuManager) {
    ...
    IMenuManager submenuManager =
        new MenuManager(
            SimplePDLEditorPlugin.INSTANCE.getString("_UI_SimplepdlEditor_menu"),
            "simplepdlMenuID");
    ...
    createChildMenuManager =
        new MenuManager(SimplePDLEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    createSiblingMenuManager =
        new MenuManager(SimplePDLEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
