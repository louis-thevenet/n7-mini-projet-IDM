 ...
 * </p>
 * <ul>
 *   <li>{@link petriNet.impl.PetriNetImpl#getNetElements <em>Net Elements</em>}</li>
...
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	/**
	 * The cached value of the '{@link #getNetElements() <em>Net Elements</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNetElements()
	 * @generated
	...
	public EList<NetElement> getNetElements() {
		if (netElements == null) {
			netElements = new EObjectContainmentEList<NetElement>(NetElement.class, this, PetriNetPackage.PETRI_NET__NET_ELEMENTS);
		}
		return netElements;
	}
