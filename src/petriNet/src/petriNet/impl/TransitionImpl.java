 ...
 *
 * <ul>
 *   <li>{@link petriNet.impl.TransitionImpl#getArcs <em>Arcs</em>}
 *   <li>{@link petriNet.impl.TransitionImpl#getName <em>Name</em>}
 *   <li>{@link petriNet.impl.TransitionImpl#getTempsMin <em>Temps Min</em>}
 *   <li>{@link petriNet.impl.TransitionImpl#getTempsMax <em>Temps Max</em>}
 *   <li>{@link petriNet.impl.TransitionImpl#isTempsMaxBorne <em>Temps Max Borne</em>}
 * </ul>
 *
 * @generated
 */
    ...
    if (arcs == null) {
      arcs =
          new EObjectWithInverseResolvingEList<Arc>(
              Arc.class,
              this,
              PetriNetPackage.TRANSITION__ARCS,
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, PetriNetPackage.TRANSITION__NAME, oldName, name));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PetriNetPackage.TRANSITION__TEMPS_MIN,
              oldTempsMin,
              tempsMin));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PetriNetPackage.TRANSITION__TEMPS_MAX,
              oldTempsMax,
              tempsMax));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PetriNetPackage.TRANSITION__TEMPS_MAX_BORNE,
              oldTempsMaxBorne,
              tempsMaxBorne));
  }
