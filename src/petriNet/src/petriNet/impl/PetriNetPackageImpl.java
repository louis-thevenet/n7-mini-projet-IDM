...
public class PetriNetPackageImpl extends EPackageImpl implements PetriNetPackage {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link PetriNetPackage#eINSTANCE} when that field is
  ...
  public static PetriNetPackage init() {
    ...
    PetriNetPackageImpl thePetriNetPackage =
        registeredPetriNetPackage instanceof PetriNetPackageImpl
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEAttribute(
        getArc_LinkDirection(),
        this.getLinkDirection(),
        "linkDirection",
        null,
        0,
        1,
    ...
    initEReference(
        ...
        IS_ORDERED);
    initEReference(
        getArc_LinkToTransition(),
        this.getTransition(),
        this.getTransition_Arcs(),
        "linkToTransition",
        null,
        0,
        1,
