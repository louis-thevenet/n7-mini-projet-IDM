 ...
 *
 * <ul>
 *   <li>{@link petriNet.impl.ArcImpl#getWeight <em>Weight</em>}
 *   <li>{@link petriNet.impl.ArcImpl#getArcType <em>Arc Type</em>}
 *   <li>{@link petriNet.impl.ArcImpl#getLinkDirection <em>Link Direction</em>}
 *   <li>{@link petriNet.impl.ArcImpl#getLinkToPlace <em>Link To Place</em>}
 *   <li>{@link petriNet.impl.ArcImpl#getLinkToTransition <em>Link To Transition</em>}
 *   <li>{@link petriNet.impl.ArcImpl#getName <em>Name</em>}
 * </ul>
 *
 * @generated
 */
public class ArcImpl extends NetElementImpl implements Arc {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, PetriNetPackage.ARC__WEIGHT, oldWeight, weight));
  }
  ...
  public void setArcType(ArcType newArcType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, PetriNetPackage.ARC__ARC_TYPE, oldArcType, arcType));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PetriNetPackage.ARC__LINK_DIRECTION,
              oldLinkDirection,
              linkDirection));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  PetriNetPackage.ARC__LINK_TO_PLACE,
                  oldLinkToPlace,
                  linkToPlace));
      }
    }
  ...
  public void setLinkToPlace(Place newLinkToPlace) {
    if (newLinkToPlace != linkToPlace) {
      ...
      if (linkToPlace != null)
        msgs =
            ((InternalEObject) linkToPlace)
                .eInverseRemove(this, PetriNetPackage.PLACE__ARCS, Place.class, msgs);
      if (newLinkToPlace != null)
        msgs =
            ((InternalEObject) newLinkToPlace)
                .eInverseAdd(this, PetriNetPackage.PLACE__ARCS, Place.class, msgs);
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  PetriNetPackage.ARC__LINK_TO_TRANSITION,
                  oldLinkToTransition,
                  linkToTransition));
      }
    }
  ...
  public void setLinkToTransition(Transition newLinkToTransition) {
    if (newLinkToTransition != linkToTransition) {
      ...
      if (linkToTransition != null)
        msgs =
            ((InternalEObject) linkToTransition)
                .eInverseRemove(this, PetriNetPackage.TRANSITION__ARCS, Transition.class, msgs);
      if (newLinkToTransition != null)
        msgs =
            ((InternalEObject) newLinkToTransition)
                .eInverseAdd(this, PetriNetPackage.TRANSITION__ARCS, Transition.class, msgs);
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, PetriNetPackage.ARC__NAME, oldName, name));
  }
