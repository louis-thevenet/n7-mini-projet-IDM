 ...
 *
 * <ul>
 *   <li>{@link petriNet.Arc#getWeight <em>Weight</em>}
 *   <li>{@link petriNet.Arc#getArcType <em>Arc Type</em>}
 *   <li>{@link petriNet.Arc#getLinkDirection <em>Link Direction</em>}
 *   <li>{@link petriNet.Arc#getLinkToPlace <em>Link To Place</em>}
 *   <li>{@link petriNet.Arc#getLinkToTransition <em>Link To Transition</em>}
 *   <li>{@link petriNet.Arc#getName <em>Name</em>}
 * </ul>
 *
...
public interface Arc extends NetElement {
  /**
   * Returns the value of the '<em><b>Weight</b></em>' attribute. The default value is <code>"1"
   * </code>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Arc Type</b></em>' attribute. The literals are from the
   * enumeration {@link petriNet.ArcType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Link Direction</b></em>' attribute. The literals are from the
   * enumeration {@link petriNet.LinkDirection}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link petriNet.Arc#getLinkDirection <em>Link Direction</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Link To Place</b></em>' reference. It is bidirectional and its
   * opposite is '{@link petriNet.Place#getArcs <em>Arcs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Link To Transition</b></em>' reference. It is bidirectional
   * and its opposite is '{@link petriNet.Transition#getArcs <em>Arcs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link petriNet.Arc#getLinkToTransition <em>Link To Transition</em>}'
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
