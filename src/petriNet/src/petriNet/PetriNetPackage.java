...
public interface PetriNetPackage extends EPackage {
   ...
   * @ordered
   */
  int TRANSITION__TEMPS_MIN = NET_ELEMENT_FEATURE_COUNT + 2;
   ...
   * petriNet.PetriNet#getNetElements <em>Net Elements</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the reference list '{@link petriNet.Transition#getArcs
   * <em>Arcs</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link petriNet.Transition#getTempsMin <em>Temps
   * Min</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Temps Min</em>'.
   * @see petriNet.Transition#getTempsMin()
   * @see #getTransition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link petriNet.Transition#getTempsMax <em>Temps
   * Max</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @return the meta object for the attribute '<em>Temps Max</em>'.
   * @see petriNet.Transition#getTempsMax()
   * @see #getTransition()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link petriNet.Transition#isTempsMaxBorne <em>Temps
   * Max Borne</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the attribute '{@link petriNet.Arc#getLinkDirection <em>Link
   * Direction</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the reference '{@link petriNet.Arc#getLinkToPlace <em>Link To
   * Place</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the meta object for the reference '{@link petriNet.Arc#getLinkToTransition <em>Link To
   * Transition</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  interface Literals {
    /**
     * The meta object literal for the '{@link petriNet.impl.PetriNetImpl <em>Petri Net</em>}'
     * class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '<em><b>Net Elements</b></em>' containment reference list
     * feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link petriNet.impl.NetElementImpl <em>Net Element</em>}'
     * class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link petriNet.impl.TransitionImpl <em>Transition</em>}'
     * class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The meta object literal for the '{@link petriNet.LinkDirection <em>Link Direction</em>}'
     * enum.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
