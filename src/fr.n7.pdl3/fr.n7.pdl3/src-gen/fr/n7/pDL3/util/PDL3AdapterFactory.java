...
public class PDL3AdapterFactory extends AdapterFactoryImpl {
  ...
  protected PDL3Switch<Adapter> modelSwitch =
      new PDL3Switch<Adapter>() {
        ...
        @Override
        public Adapter caseResourceUsages(ResourceUsages object) {
          return createResourceUsagesAdapter();
        }
        ...
        @Override
        public Adapter caseWorkDefinitions(WorkDefinitions object) {
          return createWorkDefinitionsAdapter();
        }
        ...
        @Override
        public Adapter caseWorkSequences(WorkSequences object) {
          return createWorkSequencesAdapter();
        }
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.ResourceUsages <em>Resource
   * Usages</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   ...
   * @generated
   */
  public Adapter createResourceUsagesAdapter() {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.ResourceUsage <em>Resource
   * Usage</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.Resources <em>Resources</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.Resource <em>Resource</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.WorkDefinitions <em>Work
   * Definitions</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   ...
   * @generated
   */
  public Adapter createWorkDefinitionsAdapter() {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.WorkDefinition <em>Work
   * Definition</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.WorkSequences <em>Work
   * Sequences</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
   ...
   * @generated
   */
  public Adapter createWorkSequencesAdapter() {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link fr.n7.pDL3.WorkSequence <em>Work
   * Sequence</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases; it's useful to
   * ignore a case when inheritance will catch all the cases anyway.
