 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Work Sequence Kind</b></em>', and
 * utility methods for working with them.
 * <!-- end-user-doc -->
 *
 * @see fr.n7.pDL3.PDL3Package#getWorkSequenceKind()
 * @model
 * @generated
 */
public enum WorkSequenceKind implements Enumerator {
   ...
   * @ordered
   */
  FINISH_TO_START(0, "FinishToStart", "f2s"),
   ...
   * @ordered
   */
  START_TO_START(2, "StartToStart", "s2s"),
   ...
   * @ordered
   */
  START_TO_FINISH(3, "StartToFinish", "s2f");
   ...
   * @generated
   */
  public static final List<WorkSequenceKind> VALUES =
