 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.pDL3.impl.ResourceUsageImpl#getWorkDefinition <em>Work Definition</em>}</li>
 *   <li>{@link fr.n7.pDL3.impl.ResourceUsageImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link fr.n7.pDL3.impl.ResourceUsageImpl#getNeeded <em>Needed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceUsageImpl extends ResourceUsagesImpl implements ResourceUsage
{
    ...
    if (workDefinition != null && workDefinition.eIsProxy())
    {
      ...
      if (workDefinition != oldWorkDefinition)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDL3Package.RESOURCE_USAGE__WORK_DEFINITION, oldWorkDefinition, workDefinition));
      }
    }
  ...
  public void setWorkDefinition(WorkDefinition newWorkDefinition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL3Package.RESOURCE_USAGE__WORK_DEFINITION, oldWorkDefinition, workDefinition));
  }
  ...
  public Resource getResource()
  {
    if (resource != null && resource.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDL3Package.RESOURCE_USAGE__RESOURCE, oldResource, resource));
      }
    }
    return resource;
  }
  ...
  public void setResource(Resource newResource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL3Package.RESOURCE_USAGE__RESOURCE, oldResource, resource));
  }
  ...
  public void setNeeded(int newNeeded)
  {
    ...
    needed = newNeeded;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDL3Package.RESOURCE_USAGE__NEEDED, oldNeeded, needed));
  }
