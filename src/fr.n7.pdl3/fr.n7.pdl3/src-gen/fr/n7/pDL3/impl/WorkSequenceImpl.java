 ...
 *
 * <ul>
 *   <li>{@link fr.n7.pDL3.impl.WorkSequenceImpl#getLinkToPredecessor <em>Link To Predecessor</em>}
 *   <li>{@link fr.n7.pDL3.impl.WorkSequenceImpl#getLinkType <em>Link Type</em>}
 *   <li>{@link fr.n7.pDL3.impl.WorkSequenceImpl#getLinkToSucessor <em>Link To Sucessor</em>}
 * </ul>
 *
 * @generated
 */
public class WorkSequenceImpl extends WorkSequencesImpl implements WorkSequence {
  /**
   * The cached value of the '{@link #getLinkToPredecessor() <em>Link To Predecessor</em>}'
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  PDL3Package.WORK_SEQUENCE__LINK_TO_PREDECESSOR,
                  oldLinkToPredecessor,
                  linkToPredecessor));
      }
    }
  ...
  public void setLinkType(WorkSequenceKind newLinkType) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, PDL3Package.WORK_SEQUENCE__LINK_TYPE, oldLinkType, linkType));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  this,
                  Notification.RESOLVE,
                  PDL3Package.WORK_SEQUENCE__LINK_TO_SUCESSOR,
                  oldLinkToSucessor,
                  linkToSucessor));
      }
    }
