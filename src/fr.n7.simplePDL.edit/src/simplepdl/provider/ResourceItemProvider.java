  ...
  protected void addTotalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_total_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_total_feature", "_UI_Resource_type"),
				 SimplepdlPackage.Literals.RESOURCE__TOTAL,
				 true,
				 false,
				 false,
