...
public class ResourceUsageItemProvider extends ProcessElementItemProvider {
    ...
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                ...
                "_UI_ResourceUsage_need_feature",
                "_UI_ResourceUsage_type"),
  ...
  protected void addResourcePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_ResourceUsage_resource_feature",
                "_UI_ResourceUsage_type"),
  ...
  protected void addLinkToWorkDefinitionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_ResourceUsage_linkToWorkDefinition_feature",
                "_UI_ResourceUsage_type"),
  ...
  public String getText(Object object) {
    ...
    return getString("_UI_ResourceUsage_type") + " " + resourceUsage.getNeed();
  }
