    ...
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                ...
                "_UI_WorkDefinition_linksToPredecessors_feature",
  ...
  protected void addLinksToSuccessorsPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_WorkDefinition_linksToSuccessors_feature",
                "_UI_WorkDefinition_type"),
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_WorkDefinition_name_feature",
                "_UI_WorkDefinition_type"),
  ...
  protected void addResourceUsedPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
            getResourceLocator(),
            getString("_UI_WorkDefinition_resourceUsed_feature"),
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_WorkDefinition_resourceUsed_feature",
                "_UI_WorkDefinition_type"),
            SimplepdlPackage.Literals.WORK_DEFINITION__RESOURCE_USED,
            true,
            false,
            true,
            null,
