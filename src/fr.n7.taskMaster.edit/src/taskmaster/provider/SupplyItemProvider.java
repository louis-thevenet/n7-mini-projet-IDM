...
/**
 * This is the item provider adapter for a {@link taskmaster.Supply} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class SupplyItemProvider extends ItemProviderAdapter
  ...
  protected void addConsumablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getResourceLocator(),
            getString("_UI_Supply_consumable_feature"),
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_Supply_consumable_feature",
                "_UI_Supply_type"),
            TaskmasterPackage.Literals.SUPPLY__CONSUMABLE,
            true,
            false,
            false,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
            getResourceLocator(),
            getString("_UI_Supply_name_feature"),
            getString(
                "_UI_PropertyDescriptor_description", "_UI_Supply_name_feature", "_UI_Supply_type"),
            TaskmasterPackage.Literals.SUPPLY__NAME,
            true,
            false,
            false,
  ...
  protected void addAvailablePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
            getResourceLocator(),
            getString("_UI_Supply_available_feature"),
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_Supply_available_feature",
                "_UI_Supply_type"),
            TaskmasterPackage.Literals.SUPPLY__AVAILABLE,
            true,
            false,
            false,
  ...
  public String getText(Object object) {
    String label = ((Supply) object).getName();
