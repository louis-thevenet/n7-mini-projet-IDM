  ...
  protected void addWeightPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description", "_UI_Arc_weight_feature", "_UI_Arc_type"),
  ...
  protected void addArcTypePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description", "_UI_Arc_arcType_feature", "_UI_Arc_type"),
  ...
  protected void addLinkToTransitionPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add(
        createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description",
                "_UI_Arc_linkToTransition_feature",
                "_UI_Arc_type"),
