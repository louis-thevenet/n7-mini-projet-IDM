 ...
 *
 * <ul>
 *   <li>{@link taskmaster.impl.PhysicalImpl#getRequested <em>Requested</em>}
 *   <li>{@link taskmaster.impl.PhysicalImpl#getTarget <em>Target</em>}
 * </ul>
 *
 * @generated
 */
public class PhysicalImpl extends RequirementImpl implements Physical {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              TaskmasterPackage.PHYSICAL__REQUESTED,
              oldRequested,
              requested));
  }
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  TaskmasterPackage.PHYSICAL__TARGET,
                  oldTarget,
                  target));
      }
    }
  ...
  public void setTarget(Supply newTarget) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, TaskmasterPackage.PHYSICAL__TARGET, oldTarget, target));
  }
