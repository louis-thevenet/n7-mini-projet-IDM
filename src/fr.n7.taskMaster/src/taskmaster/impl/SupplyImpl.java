 ...
 *
 * <ul>
 *   <li>{@link taskmaster.impl.SupplyImpl#isConsumable <em>Consumable</em>}
 *   <li>{@link taskmaster.impl.SupplyImpl#getName <em>Name</em>}
 *   <li>{@link taskmaster.impl.SupplyImpl#getAvailable <em>Available</em>}
 *   <li>{@link taskmaster.impl.SupplyImpl#getBundle <em>Bundle</em>}
 * </ul>
 *
 * @generated
 */
public class SupplyImpl extends MinimalEObjectImpl.Container implements Supply {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              TaskmasterPackage.SUPPLY__CONSUMABLE,
              oldConsumable,
              consumable));
  }
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, TaskmasterPackage.SUPPLY__NAME, oldName, name));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              TaskmasterPackage.SUPPLY__AVAILABLE,
              oldAvailable,
              available));
  }
  ...
  public void setBundle(EventBundle newBundle) {
    if (newBundle != eInternalContainer()
        || (eContainerFeatureID() != TaskmasterPackage.SUPPLY__BUNDLE && newBundle != null)) {
      ...
      if (newBundle != null)
        msgs =
            ((InternalEObject) newBundle)
                .eInverseAdd(
                    this, TaskmasterPackage.EVENT_BUNDLE__SUPPLIES, EventBundle.class, msgs);
      msgs = basicSetBundle(newBundle, msgs);
      if (msgs != null) msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, TaskmasterPackage.SUPPLY__BUNDLE, newBundle, newBundle));
  }
