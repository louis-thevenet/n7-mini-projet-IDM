 ...
 * @generated
 */
public class TaskmasterSwitch<T> extends Switch<T> {
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case TaskmasterPackage.EVENT_BUNDLE:
        {
          EventBundle eventBundle = (EventBundle) theEObject;
          T result = caseEventBundle(eventBundle);
          if (result == null) result = defaultCase(theEObject);
          return result;
        }
      case TaskmasterPackage.SUPPLY:
        {
      ...
      case TaskmasterPackage.REQUIREMENT:
        {
      ...
      case TaskmasterPackage.CAUSAL:
        {
          Causal causal = (Causal) theEObject;
          T result = caseCausal(causal);
          if (result == null) result = caseRequirement(causal);
          if (result == null) result = defaultCase(theEObject);
          return result;
        }
      case TaskmasterPackage.PHYSICAL:
        {
          Physical physical = (Physical) theEObject;
          T result = casePhysical(physical);
          if (result == null) result = caseRequirement(physical);
          if (result == null) result = defaultCase(theEObject);
          return result;
        }
      default:
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Event Bundle</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Event Bundle</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEventBundle(EventBundle object) {
    return null;
  }
