 ...
 *
 * <ul>
 *   <li>{@link taskmaster.EventBundle#getName <em>Name</em>}
 *   <li>{@link taskmaster.EventBundle#getSupplies <em>Supplies</em>}
 *   <li>{@link taskmaster.EventBundle#getEvents <em>Events</em>}
 * </ul>
 *
...
public interface EventBundle extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Supplies</b></em>' containment reference list. The list
   * contents are of type {@link taskmaster.Supply}. It is bidirectional and its opposite is '{@link
   * taskmaster.Supply#getBundle <em>Bundle</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Returns the value of the '<em><b>Events</b></em>' containment reference list. The list contents
   * are of type {@link taskmaster.Event}. It is bidirectional and its opposite is '{@link
   * taskmaster.Event#getBundle <em>Bundle</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
