 ...
 *
 * <ul>
 *   <li>{@link simplepdl.WorkSequence#getLinkType <em>Link Type</em>}
 *   <li>{@link simplepdl.WorkSequence#getPredecessor <em>Predecessor</em>}
 *   <li>{@link simplepdl.WorkSequence#getSuccessor <em>Successor</em>}
 * </ul>
 *
...
public interface WorkSequence extends ProcessElement {
   ...
   * enumeration {@link simplepdl.WorkSequenceType}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link simplepdl.WorkSequence#getLinkType <em>Link Type</em>}'
   * attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * opposite is '{@link simplepdl.WorkDefinition#getLinksToSuccessors <em>Links To
   * Successors</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link simplepdl.WorkSequence#getPredecessor <em>Predecessor</em>}'
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   ...
   * opposite is '{@link simplepdl.WorkDefinition#getLinksToPredecessors <em>Links To
   * Predecessors</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link simplepdl.WorkSequence#getSuccessor <em>Successor</em>}'
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
