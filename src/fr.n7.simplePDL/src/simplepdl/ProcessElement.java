...
public interface ProcessElement extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Process</b></em>' container reference. It is bidirectional and
   * its opposite is '{@link simplepdl.Process#getProcessElements <em>Process Elements</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
  ...
  /**
   * Sets the value of the '{@link simplepdl.ProcessElement#getProcess <em>Process</em>}' container
   * reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
