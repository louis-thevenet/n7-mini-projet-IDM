...
public abstract class ProcessElementImpl extends MinimalEObjectImpl.Container
  ...
  public NotificationChain basicSetProcess(simplepdl.Process newProcess, NotificationChain msgs) {
    msgs =
        eBasicSetContainer(
            (InternalEObject) newProcess, SimplepdlPackage.PROCESS_ELEMENT__PROCESS, msgs);
    return msgs;
  }
  ...
  public void setProcess(simplepdl.Process newProcess) {
    if (newProcess != eInternalContainer()
        || (eContainerFeatureID() != SimplepdlPackage.PROCESS_ELEMENT__PROCESS
            && newProcess != null)) {
    ...
    switch (eContainerFeatureID()) {
      case SimplepdlPackage.PROCESS_ELEMENT__PROCESS:
        return eInternalContainer()
            .eInverseRemove(
                this, SimplepdlPackage.PROCESS__PROCESS_ELEMENTS, simplepdl.Process.class, msgs);
    }
