 ...
 * </p>
 * <ul>
 *   <li>{@link simplepdl.impl.ResourceUsageImpl#getNeed <em>Need</em>}</li>
 *   <li>{@link simplepdl.impl.ResourceUsageImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link simplepdl.impl.ResourceUsageImpl#getName <em>Name</em>}</li>
 *   <li>{@link simplepdl.impl.ResourceUsageImpl#getLinkToWorkDefinition <em>Link To Work Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceUsageImpl extends ProcessElementImpl implements ResourceUsage {
	...
	/**
	 * The cached value of the '{@link #getLinkToWorkDefinition() <em>Link To Work Definition</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setNeed(int newNeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESOURCE_USAGE__NEED, oldNeed, need));
	}
	...
	public Resource getResource() {
		if (resource != null && resource.eIsProxy()) {
			...
			if (resource != oldResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimplepdlPackage.RESOURCE_USAGE__RESOURCE, oldResource, resource));
			}
		}
		return resource;
	}
	...
	public void setResource(Resource newResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESOURCE_USAGE__RESOURCE, oldResource, resource));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESOURCE_USAGE__NAME, oldName, name));
	}
	...
	public WorkDefinition getLinkToWorkDefinition() {
		if (linkToWorkDefinition != null && linkToWorkDefinition.eIsProxy()) {
			...
			if (linkToWorkDefinition != oldLinkToWorkDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimplepdlPackage.RESOURCE_USAGE__LINK_TO_WORK_DEFINITION, oldLinkToWorkDefinition, linkToWorkDefinition));
			}
		}
	...
	public NotificationChain basicSetLinkToWorkDefinition(WorkDefinition newLinkToWorkDefinition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESOURCE_USAGE__LINK_TO_WORK_DEFINITION, oldLinkToWorkDefinition, newLinkToWorkDefinition);
	...
	public void setLinkToWorkDefinition(WorkDefinition newLinkToWorkDefinition) {
		if (newLinkToWorkDefinition != linkToWorkDefinition) {
			...
			if (linkToWorkDefinition != null)
				msgs = ((InternalEObject)linkToWorkDefinition).eInverseRemove(this, SimplepdlPackage.WORK_DEFINITION__RESOURCE_USED, WorkDefinition.class, msgs);
			if (newLinkToWorkDefinition != null)
				msgs = ((InternalEObject)newLinkToWorkDefinition).eInverseAdd(this, SimplepdlPackage.WORK_DEFINITION__RESOURCE_USED, WorkDefinition.class, msgs);
			msgs = basicSetLinkToWorkDefinition(newLinkToWorkDefinition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESOURCE_USAGE__LINK_TO_WORK_DEFINITION, newLinkToWorkDefinition, newLinkToWorkDefinition));
	}
