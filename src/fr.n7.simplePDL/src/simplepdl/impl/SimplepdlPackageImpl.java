...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
  ...
  public void initializePackageContents() {
		...
		initEReference(getResourceUsage_Resource(), this.getResource(), null, "resource", null, 1, 1, ResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResourceUsage_LinkToWorkDefinition(), this.getWorkDefinition(), this.getWorkDefinition_ResourceUsed(), "linkToWorkDefinition", null, 1, 1, ResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
