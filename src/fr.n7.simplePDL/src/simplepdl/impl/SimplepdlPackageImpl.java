...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
   ...
   * which it depends.
   *
   * <p>This method is used to initialize {@link SimplepdlPackage#eINSTANCE} when that field is
  ...
  public static SimplepdlPackage init() {
    ...
    SimplepdlPackageImpl theSimplepdlPackage =
        registeredSimplepdlPackage instanceof SimplepdlPackageImpl
  ...
  public void initializePackageContents() {
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEReference(
        getProcess_ProcessElements(),
        this.getProcessElement(),
        this.getProcessElement_Process(),
        "processElements",
        null,
        0,
        -1,
    ...
    initEClass(
        ...
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getWorkDefinition_LinksToPredecessors(),
        this.getWorkSequence(),
        this.getWorkSequence_Successor(),
        "linksToPredecessors",
        null,
        0,
        -1,
        ...
        IS_ORDERED);
    initEReference(
        getWorkDefinition_LinksToSuccessors(),
        this.getWorkSequence(),
        this.getWorkSequence_Predecessor(),
        "linksToSuccessors",
        null,
        0,
        -1,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEReference(
        getWorkDefinition_ResourceUsed(),
        this.getResourceUsage(),
        this.getResourceUsage_LinkToWorkDefinition(),
        "resourceUsed",
        null,
        0,
        -1,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEReference(
        getWorkSequence_Predecessor(),
        this.getWorkDefinition(),
        this.getWorkDefinition_LinksToSuccessors(),
        "predecessor",
        null,
        1,
        1,
    ...
    initEReference(
        ...
        this.getWorkDefinition(),
        this.getWorkDefinition_LinksToPredecessors(),
        "successor",
        null,
        1,
        1,
    ...
    initEReference(
        ...
        this.getProcess(),
        this.getProcess_ProcessElements(),
        "process",
        null,
        0,
        1,
    ...
    initEAttribute(
        ...
        IS_ORDERED);
    initEReference(
        getResourceUsage_LinkToWorkDefinition(),
        this.getWorkDefinition(),
        this.getWorkDefinition_ResourceUsed(),
