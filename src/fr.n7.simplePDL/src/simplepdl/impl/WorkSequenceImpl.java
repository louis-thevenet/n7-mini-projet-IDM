 ...
 *
 * <ul>
 *   <li>{@link simplepdl.impl.WorkSequenceImpl#getLinkType <em>Link Type</em>}
 *   <li>{@link simplepdl.impl.WorkSequenceImpl#getPredecessor <em>Predecessor</em>}
 *   <li>{@link simplepdl.impl.WorkSequenceImpl#getSuccessor <em>Successor</em>}
 * </ul>
 *
 * @generated
 */
public class WorkSequenceImpl extends ProcessElementImpl implements WorkSequence {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              SimplepdlPackage.WORK_SEQUENCE__LINK_TYPE,
              oldLinkType,
              linkType));
  }
  ...
  public NotificationChain basicSetPredecessor(
      WorkDefinition newPredecessor, NotificationChain msgs) {
  ...
  public void setPredecessor(WorkDefinition newPredecessor) {
    if (newPredecessor != predecessor) {
      ...
      if (newPredecessor != null)
        msgs =
            ((InternalEObject) newPredecessor)
                .eInverseAdd(
                    this,
                    SimplepdlPackage.WORK_DEFINITION__LINKS_TO_SUCCESSORS,
                    WorkDefinition.class,
