 ...
 *   <li>{@link simplepdl.impl.ResourceImpl#getTotal <em>Total</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceImpl extends ProcessElementImpl implements Resource {
	...
	public void setTotal(int newTotal) {
		...
		total = newTotal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.RESOURCE__TOTAL, oldTotal, total));
	}
