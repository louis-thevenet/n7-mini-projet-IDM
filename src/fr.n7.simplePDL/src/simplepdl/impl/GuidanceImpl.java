 ...
 *
 * <ul>
 *   <li>{@link simplepdl.impl.GuidanceImpl#getText <em>Text</em>}
 *   <li>{@link simplepdl.impl.GuidanceImpl#getElements <em>Elements</em>}
 * </ul>
 *
 * @generated
 */
public class GuidanceImpl extends ProcessElementImpl implements Guidance {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, SimplepdlPackage.GUIDANCE__TEXT, oldText, text));
  }
  ...
  public EList<ProcessElement> getElements() {
    if (elements == null) {
      elements =
          new EObjectResolvingEList<ProcessElement>(
              ProcessElement.class, this, SimplepdlPackage.GUIDANCE__ELEMENTS);
    }
    return elements;
  }
