...
public class PetriNetActionBarContributor extends EditingDomainActionBarContributor
  ...
  public void contributeToMenu(IMenuManager menuManager) {
    ...
    IMenuManager submenuManager =
        new MenuManager(
            PetriNetEditorPlugin.INSTANCE.getString("_UI_PetriNetEditor_menu"), "petriNetMenuID");
    ...
    createChildMenuManager =
        new MenuManager(PetriNetEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    createSiblingMenuManager =
        new MenuManager(PetriNetEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
