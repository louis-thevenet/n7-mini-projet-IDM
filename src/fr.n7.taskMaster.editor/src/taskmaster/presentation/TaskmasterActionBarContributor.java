 ...
 * @generated
 */
public class TaskmasterActionBarContributor extends EditingDomainActionBarContributor
  ...
  public void contributeToMenu(IMenuManager menuManager) {
    ...
    IMenuManager submenuManager =
        new MenuManager(
            TaskMasterEditorPlugin.INSTANCE.getString("_UI_TaskmasterEditor_menu"),
            "taskmasterMenuID");
    ...
    createChildMenuManager =
        new MenuManager(TaskMasterEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
    submenuManager.insertBefore("additions", createChildMenuManager);

    // Prepare for CreateSibling item addition or removal.
    //
    createSiblingMenuManager =
        new MenuManager(TaskMasterEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
