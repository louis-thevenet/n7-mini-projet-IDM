...
public class PDL2FactoryImpl extends EFactoryImpl implements PDL2Factory {
  ...
  public static PDL2Factory init() {
    try {
      PDL2Factory thePDL2Factory =
          (PDL2Factory) EPackage.Registry.INSTANCE.getEFactory(PDL2Package.eNS_URI);
  ...
  public EObject create(EClass eClass) {
    switch (eClass.getClassifierID()) {
      ...
      case PDL2Package.DEPENDANCE_START:
        return createDependanceStart();
      case PDL2Package.WORK_SEQUENCE_KIND_START:
        return createWorkSequenceKindStart();
      case PDL2Package.DEPENDANCE_FINISH:
        return createDependanceFinish();
      case PDL2Package.WORK_SEQUENCE_KIND_FINISH:
        return createWorkSequenceKindFinish();
