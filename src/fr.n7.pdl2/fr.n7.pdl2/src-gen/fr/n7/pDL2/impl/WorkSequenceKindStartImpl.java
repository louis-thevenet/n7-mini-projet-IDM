 ...
 *
 * <ul>
 *   <li>{@link fr.n7.pDL2.impl.WorkSequenceKindStartImpl#getStarted2Start <em>Started2 Start</em>}
 *   <li>{@link fr.n7.pDL2.impl.WorkSequenceKindStartImpl#getStarted2Finish <em>Started2
 *       Finish</em>}
 * </ul>
 *
 * @generated
 */
public class WorkSequenceKindStartImpl extends MinimalEObjectImpl.Container
    implements WorkSequenceKindStart {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PDL2Package.WORK_SEQUENCE_KIND_START__STARTED2_START,
              oldStarted2Start,
              started2Start));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PDL2Package.WORK_SEQUENCE_KIND_START__STARTED2_FINISH,
              oldStarted2Finish,
              started2Finish));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case PDL2Package.WORK_SEQUENCE_KIND_START__STARTED2_START:
        return STARTED2_START_EDEFAULT == null
            ? started2Start != null
            : !STARTED2_START_EDEFAULT.equals(started2Start);
      case PDL2Package.WORK_SEQUENCE_KIND_START__STARTED2_FINISH:
        return STARTED2_FINISH_EDEFAULT == null
            ? started2Finish != null
            : !STARTED2_FINISH_EDEFAULT.equals(started2Finish);
    }
