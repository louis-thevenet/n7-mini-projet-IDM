 ...
 *
 * <ul>
 *   <li>{@link fr.n7.pDL2.impl.WorkDefinitionImpl#getName <em>Name</em>}
 *   <li>{@link fr.n7.pDL2.impl.WorkDefinitionImpl#getLinksToPredecessors <em>Links To
 *       Predecessors</em>}
 * </ul>
 *
 * @generated
...
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
   ...
   * @ordered
   */
  protected EList<EObject> linksToPredecessors;
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, PDL2Package.WORK_DEFINITION__NAME, oldName, name));
  }
   ...
   */
  @Override
  public EList<EObject> getLinksToPredecessors() {
    if (linksToPredecessors == null) {
      linksToPredecessors =
          new EObjectContainmentEList<EObject>(
              EObject.class, this, PDL2Package.WORK_DEFINITION__LINKS_TO_PREDECESSORS);
    }
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      ...
      case PDL2Package.WORK_DEFINITION__LINKS_TO_PREDECESSORS:
        ...
        getLinksToPredecessors().addAll((Collection<? extends EObject>) newValue);
        return;
    }
