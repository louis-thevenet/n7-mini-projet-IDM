...
public class PDL2PackageImpl extends EPackageImpl implements PDL2Package {
  ...
  public static PDL2Package init() {
    ...
    PDL2PackageImpl thePDL2Package =
        registeredPDL2Package instanceof PDL2PackageImpl
            ? (PDL2PackageImpl) registeredPDL2Package
            : new PDL2PackageImpl();
  ...
  public void initializePackageContents() {
    ...
    initEClass(
        dependanceStartEClass,
        DependanceStart.class,
        "DependanceStart",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getDependanceStart_Predecessor(),
        ...
        IS_ORDERED);
    initEReference(
        getDependanceStart_Link(),
        this.getWorkSequenceKindStart(),
        null,
        "link",
        null,
        0,
    ...
    initEClass(
        workSequenceKindStartEClass,
        WorkSequenceKindStart.class,
        "WorkSequenceKindStart",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getWorkSequenceKindStart_Started2Start(),
        ecorePackage.getEString(),
        "Started2Start",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getWorkSequenceKindStart_Started2Finish(),
        ecorePackage.getEString(),
        "Started2Finish",
        null,
        0,
    ...
    initEClass(
        dependanceFinishEClass,
        DependanceFinish.class,
        "DependanceFinish",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(
        getDependanceFinish_Predecessor(),
        this.getWorkDefinition(),
        null,
        "predecessor",
        null,
        ...
        IS_ORDERED);
    initEReference(
        getDependanceFinish_Link(),
        this.getWorkSequenceKindFinish(),
        null,
        "link",
        null,
        0,
    ...
    initEClass(
        workSequenceKindFinishEClass,
        WorkSequenceKindFinish.class,
        "WorkSequenceKindFinish",
        !IS_ABSTRACT,
        !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(
        getWorkSequenceKindFinish_Finished2Start(),
        ecorePackage.getEString(),
        "Finished2Start",
        null,
        0,
        ...
        IS_ORDERED);
    initEAttribute(
        getWorkSequenceKindFinish_Finished2Finish(),
        ecorePackage.getEString(),
        "Finished2Finish",
        null,
        0,
