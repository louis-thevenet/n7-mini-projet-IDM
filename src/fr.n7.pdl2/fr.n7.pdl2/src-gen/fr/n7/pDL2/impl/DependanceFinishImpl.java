 ...
 *
 * <ul>
 *   <li>{@link fr.n7.pDL2.impl.DependanceFinishImpl#getPredecessor <em>Predecessor</em>}
 *   <li>{@link fr.n7.pDL2.impl.DependanceFinishImpl#getLink <em>Link</em>}
 * </ul>
 *
 * @generated
 */
public class DependanceFinishImpl extends MinimalEObjectImpl.Container implements DependanceFinish {
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  PDL2Package.DEPENDANCE_FINISH__PREDECESSOR,
                  oldPredecessor,
                  predecessor));
      }
    }
  ...
  public NotificationChain basicSetLink(WorkSequenceKindFinish newLink, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, PDL2Package.DEPENDANCE_FINISH__LINK, oldLink, newLink);
  ...
  public void setLink(WorkSequenceKindFinish newLink) {
    if (newLink != link) {
      ...
      if (link != null)
        msgs =
            ((InternalEObject) link)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - PDL2Package.DEPENDANCE_FINISH__LINK, null, msgs);
      if (newLink != null)
        msgs =
            ((InternalEObject) newLink)
                .eInverseAdd(
                    this, EOPPOSITE_FEATURE_BASE - PDL2Package.DEPENDANCE_FINISH__LINK, null, msgs);
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, PDL2Package.DEPENDANCE_FINISH__LINK, newLink, newLink));
  }
