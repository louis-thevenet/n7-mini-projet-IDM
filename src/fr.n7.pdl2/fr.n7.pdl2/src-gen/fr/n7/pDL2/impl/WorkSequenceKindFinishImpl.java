 ...
 *
 * <ul>
 *   <li>{@link fr.n7.pDL2.impl.WorkSequenceKindFinishImpl#getFinished2Start <em>Finished2
 *       Start</em>}
 *   <li>{@link fr.n7.pDL2.impl.WorkSequenceKindFinishImpl#getFinished2Finish <em>Finished2
 *       Finish</em>}
 * </ul>
 *
 * @generated
 */
public class WorkSequenceKindFinishImpl extends MinimalEObjectImpl.Container
    implements WorkSequenceKindFinish {
  /**
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PDL2Package.WORK_SEQUENCE_KIND_FINISH__FINISHED2_START,
              oldFinished2Start,
              finished2Start));
  }
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(
              this,
              Notification.SET,
              PDL2Package.WORK_SEQUENCE_KIND_FINISH__FINISHED2_FINISH,
              oldFinished2Finish,
              finished2Finish));
  }
  ...
  public boolean eIsSet(int featureID) {
    switch (featureID) {
      case PDL2Package.WORK_SEQUENCE_KIND_FINISH__FINISHED2_START:
        return FINISHED2_START_EDEFAULT == null
            ? finished2Start != null
            : !FINISHED2_START_EDEFAULT.equals(finished2Start);
      case PDL2Package.WORK_SEQUENCE_KIND_FINISH__FINISHED2_FINISH:
        return FINISHED2_FINISH_EDEFAULT == null
            ? finished2Finish != null
            : !FINISHED2_FINISH_EDEFAULT.equals(finished2Finish);
    }
