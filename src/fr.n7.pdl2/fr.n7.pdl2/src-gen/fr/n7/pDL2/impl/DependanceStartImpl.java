 ...
 *
 * <ul>
 *   <li>{@link fr.n7.pDL2.impl.DependanceStartImpl#getPredecessor <em>Predecessor</em>}
 *   <li>{@link fr.n7.pDL2.impl.DependanceStartImpl#getLink <em>Link</em>}
 * </ul>
 *
 * @generated
 */
public class DependanceStartImpl extends MinimalEObjectImpl.Container implements DependanceStart {
        ...
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(
                  ...
                  PDL2Package.DEPENDANCE_START__PREDECESSOR,
                  oldPredecessor,
                  predecessor));
      }
    }
  ...
  public NotificationChain basicSetLink(WorkSequenceKindStart newLink, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this, Notification.SET, PDL2Package.DEPENDANCE_START__LINK, oldLink, newLink);
  ...
  public void setLink(WorkSequenceKindStart newLink) {
    if (newLink != link) {
      ...
      if (link != null)
        msgs =
            ((InternalEObject) link)
                .eInverseRemove(
                    this, EOPPOSITE_FEATURE_BASE - PDL2Package.DEPENDANCE_START__LINK, null, msgs);
      if (newLink != null)
        msgs =
      ...
      eNotify(
          new ENotificationImpl(
              this, Notification.SET, PDL2Package.DEPENDANCE_START__LINK, newLink, newLink));
  }
